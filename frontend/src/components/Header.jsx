      ...
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
          ...
          <p>
            ...
            <br className="hidden sm:block"/>schedule your appointment hasle-free.
            
          </p>
        </div>
        <a href="#speciality" className="flex items-center gap-2 bg-white px-4 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300">
